...
import sys
sys.path.append('/opt')
from utils.working_http_snowflake_connector import SnowflakeConnector
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if test_result['status'] != 'success':
            raise Exception(f"Failed to connect to Snowflake: {test_result.get('error', 'Unknown error')}")
